...
namespace LiteNetLib.Utils
{
    ...
    ///     Make NTP request.
    ///     <para>
    ///         1. Create the object by
    ///         <see cref="Create(IPEndPoint,System.Action{LiteNetLib.Utils.NtpPacket}(LiteNetLib.Utils.NtpPacket))" /> method.
    ///     </para>
    ///     <para>
    ...
    public sealed class NtpRequest : INetSocketListener
    {
            ...
            IPEndPoint remoteEndPoint)
        {
            ...
            var packet = NtpPacket.FromServerResponse(data, destinationTimestamp);
            try
            {
        ...
        {
            var endPoint = NetUtils.MakeEndPoint(ntpServerAddress, DefaultPort);
            return Create(endPoint, onRequestComplete);
        }
