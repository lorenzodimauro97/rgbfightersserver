...
namespace MessagePack
{
    ...
    internal ref struct BufferWriter
    {
        ...
        /// <summary>
        ///     The result of the last call to <see cref="IBufferWriter{T}.GetMemory(int)" />, less any bytes already "consumed"
        ///     with <see cref="Advance(int)" />.
        /// </summary>
        ...
        /// <summary>
        ///     Copies the caller's buffer into this writer and calls <see cref="Advance(int)" /> with the length of the source
        ///     buffer.
        /// </summary>
