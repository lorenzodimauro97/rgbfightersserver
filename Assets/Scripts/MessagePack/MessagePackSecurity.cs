...
namespace MessagePack
{
    ...
    public class MessagePackSecurity
    {
        ...
        protected virtual IEqualityComparer<T> GetHashCollisionResistantEqualityComparer<T>()
        {
            ...
            else
            {
                ...
                result =
                    ...
                    typeof(T) == typeof(bool)
                        ? CollisionResistantHasher<T>.Instance
                        :
                                            ...
                                            typeof(T) == typeof(int)
                                                ...
                                                typeof(T) == typeof(uint)
                                                    ...
                                                    typeof(T) == typeof(long)
                                                        ? (IEqualityComparer<T>) Int64EqualityComparer.Instance
                                                        :
                                                        typeof(T) == typeof(ulong)
                                                            ? (IEqualityComparer<T>) UInt64EqualityComparer.Instance
                                                            :
                                                            typeof(T) == typeof(float)
                                                                ? (IEqualityComparer<T>) SingleEqualityComparer.Instance
                                                                :
                                                                typeof(T) == typeof(double)
                                                                    ...
                                                                    typeof(T) == typeof(string)
                                                                        ? (IEqualityComparer<T>) StringEqualityComparer
                                                                            .Instance
                                                                        :
                                                                        typeof(T) == typeof(Guid)
                                                                            ? (IEqualityComparer<T>)
                                                                            GuidEqualityComparer.Instance
                                                                            :
                                                                            typeof(T) == typeof(DateTime)
                                                                                ? (IEqualityComparer<T>)
                                                                                DateTimeEqualityComparer.Instance
                                                                                :
                                                                                typeof(T) == typeof(DateTimeOffset)
                                                                                    ...
                                                                                    typeof(T) == typeof(object)
                                                                                        ? (IEqualityComparer<T>)
                                                                                        objectFallbackEqualityComparer
                                                                                        :
                                                                                        null;
            }
            ...
            return result ??
                   throw new TypeAccessException(
                       $"No hash-resistant equality comparer available for type: {typeof(T)}");
        }
        ...
        {
            private static readonly MethodInfo GetHashCollisionResistantEqualityComparerOpenGenericMethod =
                typeof(MessagePackSecurity).GetTypeInfo().DeclaredMethods.Single(m =>
                    m.Name == nameof(GetHashCollisionResistantEqualityComparer) && m.IsGenericMethod);

            private readonly ThreadsafeTypeKeyHashTable<IEqualityComparer> equalityComparerCache =
                new ThreadsafeTypeKeyHashTable<IEqualityComparer>();
            ...
            public int GetHashCode(object value)
            {
                ...
                if (!equalityComparerCache.TryGetValue(valueType, out var equalityComparer))
                {
                    ...
                    {
                        equalityComparer =
                            (IEqualityComparer) GetHashCollisionResistantEqualityComparerOpenGenericMethod
                                .MakeGenericMethod(valueType).Invoke(security, Array.Empty<object>());
                    }
