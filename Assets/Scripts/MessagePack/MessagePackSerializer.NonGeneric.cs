...
namespace MessagePack
{
    public partial class MessagePackSerializer
    {
        ...
        private static readonly ThreadsafeTypeKeyHashTable<CompiledMethods> Serializes =
            new ThreadsafeTypeKeyHashTable<CompiledMethods>(64);
        ...
        public static void Serialize(Type type, IBufferWriter<byte> writer, object obj,
            MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            GetOrAdd(type).Serialize_IBufferWriter_T_Options_CancellationToken
                .Invoke(writer, obj, options, cancellationToken);
        }
        ...
        public static Task SerializeAsync(Type type, Stream stream, object obj,
            MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            return GetOrAdd(type).SerializeAsync_Stream_T_Options_CancellationToken
                .Invoke(stream, obj, options, cancellationToken);
        }

        /// <seealso cref="Deserialize{T}(ref MessagePackReader, MessagePackSerializerOptions)" />
        public static object Deserialize(Type type, ref MessagePackReader reader,
            MessagePackSerializerOptions options = null)
        {
        ...
        public static object Deserialize(Type type, Stream stream, MessagePackSerializerOptions options = null,
            CancellationToken cancellationToken = default)
        {
            return GetOrAdd(type).Deserialize_Stream_Options_CancellationToken
                .Invoke(stream, options, cancellationToken);
        }
        ...
        public static ValueTask<object> DeserializeAsync(Type type, Stream stream,
            MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            return GetOrAdd(type).DeserializeAsync_Stream_Options_CancellationToken
                .Invoke(stream, options, cancellationToken);
        }
        ...
        public static object Deserialize(Type type, ReadOnlySequence<byte> bytes,
            MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            return GetOrAdd(type).Deserialize_ReadOnlySequence_Options_CancellationToken
                .Invoke(bytes, options, cancellationToken);
        }

        private static async ValueTask<object> DeserializeObjectAsync<T>(Stream stream,
        ...
        private class CompiledMethods
        {
            internal CompiledMethods(Type type)
            {
                var ti = type.GetTypeInfo();
                {
                    ...
                    var serialize = GetMethod(nameof(Serialize), type,
                        new[] {null, typeof(MessagePackSerializerOptions), typeof(CancellationToken)});
                    ...
                    var lambda = Expression
                        .Lambda<Func<object, MessagePackSerializerOptions, CancellationToken, byte[]>>(body, param1,
                            param2, param3).Compile();

                    Serialize_T_Options = lambda;
                }

                {
                    ...
                    var serialize = GetMethod(nameof(Serialize), type,
                        new[] {typeof(Stream), null, typeof(MessagePackSerializerOptions), typeof(CancellationToken)});
                    ...
                    var body = Expression.Call(
                        ...
                        param4);
                    var lambda = Expression
                        .Lambda<Action<Stream, object, MessagePackSerializerOptions, CancellationToken>>(body, param1,
                            param2, param3, param4).Compile();

                    Serialize_Stream_T_Options_CancellationToken = lambda;
                }

                {
                    ...
                    var serialize = GetMethod(nameof(SerializeAsync), type,
                        new[] {typeof(Stream), null, typeof(MessagePackSerializerOptions), typeof(CancellationToken)});
                    ...
                    var body = Expression.Call(
                        ...
                        param4);
                    var lambda = Expression
                        .Lambda<Func<Stream, object, MessagePackSerializerOptions, CancellationToken, Task>>(body,
                            param1, param2, param3, param4).Compile();

                    SerializeAsync_Stream_T_Options_CancellationToken = lambda;
                }

                {
                    ...
                    var serialize = GetMethod(nameof(Serialize), type,
                        new[]
                        {
                            typeof(IBufferWriter<byte>), null, typeof(MessagePackSerializerOptions),
                    ...
                    var body = Expression.Call(
                        ...
                        param4);
                    var lambda = Expression
                        .Lambda<Action<IBufferWriter<byte>, object, MessagePackSerializerOptions, CancellationToken>>(
                            body, param1, param2, param3, param4).Compile();

                    Serialize_IBufferWriter_T_Options_CancellationToken = lambda;
                }

                {
                    // public static void Serialize<T>(ref MessagePackWriter writer, T obj, MessagePackSerializerOptions options)
                    var serialize = GetMethod(nameof(Serialize), type,
                        new[] {typeof(MessagePackWriter).MakeByRefType(), null, typeof(MessagePackSerializerOptions)});
                    ...
                    var body = Expression.Call(
                        ...
                        ti.IsValueType ? Expression.Unbox(param2, type) : Expression.Convert(param2, type),
                        param3);
                    var lambda = Expression.Lambda<MessagePackWriterSerialize>(body, param1, param2, param3).Compile();

                    Serialize_MessagePackWriter_T_Options = lambda;
                }

                {
                    // public static T Deserialize<T>(ref MessagePackReader reader, MessagePackSerializerOptions options)
                    var deserialize = GetMethod(nameof(Deserialize), type,
                    ...
                    var lambda = Expression.Lambda<MessagePackReaderDeserialize>(body, param1, param2).Compile();

                    Deserialize_MessagePackReader_Options = lambda;
                }

                {
                    // public static T Deserialize<T>(Stream stream, MessagePackSerializerOptions options, CancellationToken cancellationToken)
                    var deserialize = GetMethod(nameof(Deserialize), type,
                        new[] {typeof(Stream), typeof(MessagePackSerializerOptions), typeof(CancellationToken)});

                    var param1 = Expression.Parameter(typeof(Stream), "stream");
                    var param2 = Expression.Parameter(typeof(MessagePackSerializerOptions), "options");
                    var param3 = Expression.Parameter(typeof(CancellationToken), "cancellationToken");
                    var body = Expression.Convert(Expression.Call(null, deserialize, param1, param2, param3),
                        typeof(object));
                    var lambda = Expression
                        .Lambda<Func<Stream, MessagePackSerializerOptions, CancellationToken, object>>(body, param1,
                            param2, param3).Compile();

                    Deserialize_Stream_Options_CancellationToken = lambda;
                }

                {
                    ...
                    var deserialize = GetMethod(nameof(DeserializeObjectAsync), type,
                        new[] {typeof(Stream), typeof(MessagePackSerializerOptions), typeof(CancellationToken)});
                    ...
                    var lambda = Expression
                        .Lambda<Func<Stream, MessagePackSerializerOptions, CancellationToken, ValueTask<object>>>(body,
                            param1, param2, param3).Compile();

                    DeserializeAsync_Stream_Options_CancellationToken = lambda;
                }

                {
                    ...
                    var deserialize = GetMethod(nameof(Deserialize), type,
                        new[]
                        {
                            typeof(ReadOnlyMemory<byte>), typeof(MessagePackSerializerOptions),
                            typeof(CancellationToken)
                        });
                    ...
                    var body = Expression.Convert(Expression.Call(null, deserialize, param1, param2, param3),
                        typeof(object));
                    var lambda = Expression
                        .Lambda<Func<ReadOnlyMemory<byte>, MessagePackSerializerOptions, CancellationToken, object>>(
                            body, param1, param2, param3).Compile();

                    Deserialize_ReadOnlyMemory_Options = lambda;
                }

                {
                    ...
                    var deserialize = GetMethod(nameof(Deserialize), type,
                        new[]
                        {
                            typeof(ReadOnlySequence<byte>).MakeByRefType(), typeof(MessagePackSerializerOptions),
                            typeof(CancellationToken)
                        });
                    ...
                    var body = Expression.Convert(Expression.Call(null, deserialize, param1, param2, param3),
                        typeof(object));
                    var lambda = Expression
                        .Lambda<Func<ReadOnlySequence<byte>, MessagePackSerializerOptions, CancellationToken, object>>(
                            body, param1, param2, param3).Compile();

                    Deserialize_ReadOnlySequence_Options_CancellationToken = lambda;
                }
            }
            ...
            private static MethodInfo GetMethod(string methodName, Type type, Type[] parameters)
            {
                return typeof(MessagePackSerializer).GetRuntimeMethods().Single(x =>
                    {
                        if (methodName != x.Name) return false;
            ...
            internal delegate void MessagePackWriterSerialize(ref MessagePackWriter writer, object value,
                MessagePackSerializerOptions options);

            internal delegate object MessagePackReaderDeserialize(ref MessagePackReader reader,
                MessagePackSerializerOptions options);
...
#pragma warning disable SA1401 // Fields should be private
            ...
            internal readonly Action<Stream, object, MessagePackSerializerOptions, CancellationToken>
                Serialize_Stream_T_Options_CancellationToken;

            internal readonly Func<Stream, object, MessagePackSerializerOptions, CancellationToken, Task>
                SerializeAsync_Stream_T_Options_CancellationToken;

            internal readonly MessagePackWriterSerialize Serialize_MessagePackWriter_T_Options;

            internal readonly Action<IBufferWriter<byte>, object, MessagePackSerializerOptions, CancellationToken>
                Serialize_IBufferWriter_T_Options_CancellationToken;

            internal readonly MessagePackReaderDeserialize Deserialize_MessagePackReader_Options;

            internal readonly Func<Stream, MessagePackSerializerOptions, CancellationToken, object>
                Deserialize_Stream_Options_CancellationToken;

            internal readonly Func<Stream, MessagePackSerializerOptions, CancellationToken, ValueTask<object>>
            ...
            internal readonly Func<ReadOnlyMemory<byte>, MessagePackSerializerOptions, CancellationToken, object>
                Deserialize_ReadOnlyMemory_Options;

            internal readonly Func<ReadOnlySequence<byte>, MessagePackSerializerOptions, CancellationToken, object>
                Deserialize_ReadOnlySequence_Options_CancellationToken;
