...
{
    /// <summary>
    ///     Singleton version of CompositeResolver, which be able to register a collection of formatters and resolvers to a
    ///     single instance.
    /// </summary>
    public class StaticCompositeResolver : IFormatterResolver
    {
        ...
        public void Register(params IMessagePackFormatter[] formatters)
        {
            ...
            if (this.formatters is null) throw new ArgumentNullException(nameof(formatters));
        ...
        ///     is used.
        /// </param>
        public void Register(IReadOnlyList<IMessagePackFormatter> formatters,
