...
namespace MessagePack.Formatters
{
    public sealed class ValueTupleFormatter<T1> : IMessagePackFormatter<ValueTuple<T1>>
    {
        ...
        public ValueTuple<T1> Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            if (count != 1) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2> value,
        ...
        public ValueTuple<T1, T2> Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 2) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3> Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 3) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3, T4> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3, T4> Deserialize(ref MessagePackReader reader,
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
            {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 4) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3, T4, T5> Deserialize(ref MessagePackReader reader,
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
            {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 5) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    public sealed class
        ValueTupleFormatter<T1, T2, T3, T4, T5, T6> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5, T6>>
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3, T4, T5, T6> Deserialize(ref MessagePackReader reader,
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
            {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 6) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    public sealed class
        ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6, T7> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3, T4, T5, T6, T7> Deserialize(ref MessagePackReader reader,
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
            {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 7) throw new MessagePackSerializationException("Invalid ValueTuple count");
    ...
    public sealed class
        ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7, TRest> : IMessagePackFormatter<
            ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>
        where TRest : struct
    {
        public void Serialize(ref MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> value,
            MessagePackSerializerOptions options)
        {
        ...
        public ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> Deserialize(ref MessagePackReader reader,
            MessagePackSerializerOptions options)
        {
            if (reader.IsNil)
            {
            ...
            var count = reader.ReadArrayHeader();
            if (count != 8) throw new MessagePackSerializationException("Invalid ValueTuple count");
            ...
            try
            {
                ...
                return new ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>(item1, item2, item3, item4, item5, item6,
                    item7, item8);
            }
            finally
            {
