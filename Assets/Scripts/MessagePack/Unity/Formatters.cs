...
namespace MessagePack.Unity
{
    ...
    {
        public void Serialize(ref MessagePackWriter writer, GradientColorKey value,
    ...
    {
        public void Serialize(ref MessagePackWriter writer, GradientAlphaKey value,
            MessagePackSerializerOptions options)
        {
            writer.WriteArrayHeader(2);
    ...
    public sealed class GradientFormatter : IMessagePackFormatter<Gradient>
    {
        ...
        public Gradient Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                {
                    case 0:
                        __colorKeys__ = resolver.GetFormatterWithVerify<GradientColorKey[]>()
                            .Deserialize(ref reader, options);
                        break;
                    case 1:
                        __alphaKeys__ = resolver.GetFormatterWithVerify<GradientAlphaKey[]>()
                            .Deserialize(ref reader, options);
                        break;
                    case 2:
    ...
    public sealed class BoundsIntFormatter : IMessagePackFormatter<BoundsInt>
    {
        ...
        public BoundsInt Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                {
                    case 0:
                        __position__ = options.Resolver.GetFormatterWithVerify<Vector3Int>()
                            .Deserialize(ref reader, options);
                        break;
                    case 1:
                        __size__ = options.Resolver.GetFormatterWithVerify<Vector3Int>()
                            .Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
